...
<head>
  ...
  <title>Dashboard - Announcement Management System</title>
        ...
        <ul id="posts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="tables-general.html">
              <i class="bi bi-circle"></i><span>Teachers Posts</span>
            </a>
          </li>
          <li>
            <a href="tables-data.html">
              <i class="bi bi-circle"></i><span>University Posts</span>
            </a>
          </li>
        </ul>
      </li>
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title"><?php echo $_SESSION["email"] ?><span> posts</span></h5>
